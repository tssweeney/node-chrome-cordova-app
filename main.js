...
var build = function(name){
  spawnInOrder([
    ["npm", ["install"], {stdio: 'inherit', cwd: "./" + name}, ":: 'npm install' failed."],
    ["grunt", ["tasks"], {stdio: 'inherit', cwd: "./" + name}, ":: 'Grunt tasks' failed."],
    ["cca", ["prepare"], {stdio: 'inherit', cwd: "./" + name}, ":: 'cca prepare' failed."],
    ["cca", ["build"], {stdio: 'inherit', cwd: "./" + name}, ":: 'cca build' failed."],
  ], function(err){
    process.exit();
  });
};
